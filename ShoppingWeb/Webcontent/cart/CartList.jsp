...
<head>
	...
	<link rel="stylesheet" href="<%=request.getContextPath()%>/cart/10-11.css" />
	<script type="text/javascript" src="<%=request.getContextPath()%>/cart/10-11.js"></script>  
</head>
<body>
        ...
        <c:forEach var="clist" items="${showBascket }">
                <div class="row data">
                    <div class="subdiv">
                        ...
                        <div class="img"><img src="<%=request.getContextPath() %>/upload/${clist.filename}" width="60"></div>
                        <div class="pname">
                            <span>찜마마(XJ-92214/3)</span>
                        </div>
                    </div>
                    <div class="subdiv">
                        <div class="basketprice"><input type="hidden" name="p_price" id="p_price1" class="p_price" value="${clist.cart_no}">${clist.cart_no}원</div>
                        <div class="num">
                            <div class="updown">
