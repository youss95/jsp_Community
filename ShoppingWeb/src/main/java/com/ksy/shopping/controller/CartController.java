...
public class CartController extends HttpServlet {
	...
	protected void reqpro(HttpServletRequest request, HttpServletResponse response)
		...
		} else if (cmd.equals("bascketForm")) {
			CartReqDto dto = new CartReqDto();
			
			
		int user_no = Integer.parseInt(request.getParameter("user_no"));
		System.out.println("유넘"+user_no);
		
		List<CartReqDto> clist = cartService.장바구니목록(user_no);  
			System.out.println("장바구니목록"+clist);
			request.setAttribute("showBascket",clist );
