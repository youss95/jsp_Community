	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	          ...
	          <li class="nav-item"><a href="/DogCat/blog?cmd=blogList" class="nav-link">Blog</a></li>
	          ...
	          <c:when test="${sessionScope.sessionUser != null&&sessionScope.sessionUser.userRole.equals('normal') }">
	            <li class="nav-item"><a href="/DogCat/user?cmd=JoinForm" class="nav-link">mypage</a></li>
	          <li class="nav-item"><a href="/DogCat/user?cmd=logout" class="nav-link">logout</a></li>
	          </c:when>
